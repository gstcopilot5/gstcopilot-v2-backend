                                                                                                                                                                                                      ...
                                                                                                                                                                                                      method: 'POST',
                                                                                                                                                                                                            headers: {'Content-Type': 'application/json'},
                                                                                                                                                                                                                  body: JSON.stringify({clientName, gstin, amount, dueDate})
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          const data = await res.json();
                                                                                                                                                                                                                              result.className = 'result success show';
                                                                                                                                                                                                                                  result.innerHTML = `<pre style="white-space:pre-wrap;font-size:11px;">${data.message}</pre><button id="btnCopyReminder" style="margin-top:8px;padding:4px 8px;background:#00b894;color:white;border:none;border-radius:4px;cursor:pointer;">Copy</button>`;
  document.getElementById("btnCopyReminder").addEventListener("click", () => copyText(data.message));
                                                                                                                                                                                                                                        } catch(e) {
                                                                                                                                                                                                                                            result.className = 'result error show';
                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                  body: JSON.stringify({title, content})
                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                          const blob = await res.blob();
                                                                                                                                                                                                                                                                                                                              const url = URL.createObjectURL(blob);
                                                                                                                                                                                                                                                                                                                                  const a = document.createElement('a'); a.href = url; a.download = 'gstcopilot-report.pdf'; a.click();
                                                                                                                                                                                                                                                                                                                                    } catch(e) {
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        method: 'POST',
                                                                                                                                                                                                                                                                                                                                                              headers: {'Content-Type': 'application/json'},
                                                                                                                                                                                                                                                                                                                                                                    body: JSON.stringify({headers: ['Report', 'Data'], rows: [[title, new Date().toLocaleDateString()]]})
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            const blob = await res.blob();
                                                                                                                                                                                                                                                                                                                                                                                const url = URL.createObjectURL(blob);
                                                                                                                                                                                                                                                                                                                                                                                    const a = document.createElement('a'); a.href = url; a.download = 'gstcopilot-export.xlsx'; a.click();
                                                                                                                                                                                                                                                                                                                                                                                      } catch(e) {
                                                                                                                                                                                                                                                                                                                                                                                          alert('Export failed. Try again.');
                                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                            }
